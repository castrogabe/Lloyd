...
export default function ProductMagEdit() {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const { data } = await axios.get('/api/productmagcontent', {
  ...
  return (
    <div className='content'>
      <Helmet>
        <title>ProductMag Edit</title>
      </Helmet>
      <br />
      <h1 className='box'>ProductMag Edit</h1>
